...
public:
	...
	bool SetShaderParameters(ID3D11DeviceContext	*& deviceContext, DirectX::XMMATRIX worldMatrix, DirectX::XMMATRIX viewMatrix, DirectX::XMMATRIX projectionMatrix, DirectX::XMFLOAT3 lightPos,
	DirectX::XMFLOAT3 lightColor, float radius, float lightIntensity,PointLight light[], DirectX::XMFLOAT3 camPos);
