...
bool DefferedShader::Initialize(ID3D11Device * device, HWND hwnd)
{
	bool result = false;
...
bool DefferedShader::Render(ID3D11DeviceContext *& deviceContext, int count, DirectX::XMMATRIX worldMatrix, DirectX::XMMATRIX viewMatrix, DirectX::XMMATRIX projectionMatrix)
{
	return false;
}
...
bool DefferedShader::SetShaderParameters(ID3D11DeviceContext *& deviceContext, DirectX::XMMATRIX worldMatrix, DirectX::XMMATRIX viewMatrix, DirectX::XMMATRIX projectionMatrix,
...
bool DefferedShader::InitializeShader(ID3D11Device *& device, HWND hwnd)
{
...
void DefferedShader::ShutdownShader()
{
}

void DefferedShader::OutputShaderErrorMessage(ID3D10Blob * errorMessage, HWND hwnd, WCHAR * shaderFilename)
{
	char* compileErrors;
